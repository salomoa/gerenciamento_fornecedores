...
public class FornecedorServices {
    ...
    public List<FornecedorModel> buscarTodosOsFornecedores() {
        return fornecedorRepository.findAll();
    }

    public FornecedorModel criarFornecedor(FornecedorModel fornecedor) { return fornecedorRepository.save(fornecedor); }

    public Optional<FornecedorModel> buscarFornecedorId(Long id) { return fornecedorRepository.findById(id); }

    public FornecedorModel atualizarFornecedores(Long id, FornecedorModel fornecedor) {
